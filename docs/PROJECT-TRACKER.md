...
- Current slice: [157 — Phase 16 (F-037): visible WAN package and opt-in stable-directory updates](slices/157-visible-wan-package.md) — **in progress; executable validation repaired the package cleanup, launcher-directory, manifest-default, and branch-artifact handoff defects; packaged artifact evidence remains pending**. Prior: [155](slices/155-outdated-client-launcher-handoff.md).
- Tech debt: none.
