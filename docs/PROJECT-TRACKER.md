...
- Current slice: [157 — Phase 16 (F-037): visible WAN package and opt-in stable-directory updates](slices/157-visible-wan-package.md) — **in progress; package boot, first install, and real-launcher failed-readiness rollback are proven, while signed download and valid-update runtime evidence remain**. Prior: [155](slices/155-outdated-client-launcher-handoff.md).
- Tech debt: none.
