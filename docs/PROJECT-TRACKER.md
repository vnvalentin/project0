...
- **Current slice:** [091 — Auth-gated onboarding C-client-seam: Godot `EnrollmentHttpClient`](slices/091-client-https-auth-character-seam.md) — **delivered; validated on the Linux host (client/enrollment_http_client.gd — HTTPRequest login + character list/create/select/delete, bounded fail-closed outcomes); GUT 432/432 across 63/63 scripts, exit 0 (confirmed deterministic across two runs after a flaky real-socket test was rewritten pure)**
  - **Feature:** [P-024](FEATURE-LIST.md#p-024-public-game-access-via-opnsense-native-wireguard)
- Prior slice: [090 — Auth-gated onboarding C-server: HTTPS character endpoints](slices/090-https-character-endpoints.md) — **delivered; GUT 423/423, enrollment pytest 112/112 on the Linux host**
  - **Feature:** [P-024](FEATURE-LIST.md#p-024-public-game-access-via-opnsense-native-wireguard)
