...
- Tech debt: `open` [DT-012](TECHNICAL-DEBT-TRACKER.md#dt-012-login-authority-shares-the-game-servers-image-and-codebase) — login authority shares the game server's image and codebase; `open` [DT-013](TECHNICAL-DEBT-TRACKER.md#dt-013-advertised-tick_rate-does-not-match-the-actual-authoritative-tick-rate) — advertised `tick_rate` is 30 while ticks advance at 60/s; `open` [DT-014](TECHNICAL-DEBT-TRACKER.md#dt-014-container-images-ship-without-the-wgnetstack-gdextension) — container images ship without the wgnetstack GDExtension.
